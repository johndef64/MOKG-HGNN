...
"""
Modulo per l'implementazione del modello Graph Convolutional Network (GCN)
Questo modulo contiene la definizione della classe GCN che implementa una rete neurale
per l'apprendimento su grafi utilizzando convoluzioni grafiche per la classificazione
di campioni basata su dati multi-omici integrati.
"""

from torch import nn                    # Moduli delle reti neurali di PyTorch
import torch.nn.functional as F         # Funzioni di attivazione e loss di PyTorch
from layer import GraphConvolution      # Layer di convoluzione grafica personalizzato
